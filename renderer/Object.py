...
class Object:
    ...
    def Draw(self):
        ...
        model_matrix = pyrr.matrix44.multiply(m1=rotation_matrix_z, m2=pyrr.matrix44.multiply(m1=rotation_matrix_y, m2=pyrr.matrix44.multiply(rotation_matrix_x, scaling_matrix)))
        model_matrix = pyrr.matrix44.multiply(m1=translation_matrix, m2=model_matrix)

        # Set the model matrix uniform in the shader
        self.shader.SetUniformMatrix4fv("modelMatrix", model_matrix)
